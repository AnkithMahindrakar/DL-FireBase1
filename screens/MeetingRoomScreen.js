    ...
    <>
      <View style={styles.rootContainer}>
        <View style={styles.container}>
          <Text style={styles.headerFont}>DL/Meeting room</Text>
        </View>
                ...
                ListHeaderComponent={
                  <View style={styles.descriptionContainer}>
                    <Text style={styles.description}>
                      Find the perfect meeting room in one of our great
                      locations cross London. See what’s available or browse by
                      location.
                    </Text>
                    <ButtonComponent
                      name="Lets find you a room"
                      buttonStyle={{
                        width: 380,
                        right: 20,
                  ...
                  <>
                    ...
                    <TouchableOpacity>
                      <View style={styles.DiscoverContainer}>
                        <View style={styles.discoverContainer2}>
                          <Image
                            style={styles.ftrimage}
                            source={require("../assets/4.png")}
                          />
                          <Text style={styles.DerwentTxt}>
                            Discover Derwent London
                          </Text>
                        </View>
